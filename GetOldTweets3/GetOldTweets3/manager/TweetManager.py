...
#                        .encode('ascii', 'ignore').decode('ascii') # removes the quotes
#                        .encode('latin-1', 'replace').decode('utf-8', 'replace') # replaces the quotes with the question mark
...
#                mentions.append("mentions(" + url[1:] + ") ")
